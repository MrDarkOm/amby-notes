            ...
            >
              {menu.kind === "pane" ? (
                ...
                <>
                  <MenuItem
                    onClick={() => {
                      duplicateSelectionOrOne(menu.targetId!)
                      closeMenu()
                    }}
                  >
                    <Copy className="size-3.5 text-muted-foreground" />
                ...
                <>
                  ...
                  <MenuItem
                    onClick={() => {
                      cycleArrows(menu.targetId!, "both")
                      closeMenu()
                    }}
                  >
                  ...
                  <MenuItem
                    onClick={() => {
                      cycleArrows(menu.targetId!, "none")
                      closeMenu()
                    }}
                  >
