...
Статус: **NOT RUN**. Создано 31 августа 2026 года. Этот файл — инструкция,
...
- [ ] **WIN-BUILD.1** Все команды завершились успешно; логи сохранены.
...
- [ ] **WIN-BUILD.4** Зафиксированы подпись/предупреждения SmartScreen; успешная
