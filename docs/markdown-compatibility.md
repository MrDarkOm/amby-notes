...
| Raw HTML, comments, iframes, audio/video/PDF embeds                    | **Live, opaque block**     | Block HTML is preserved as source text and never executed or normalized by the visual editor. Raw inline HTML uses an opaque inline atom.                                            |
